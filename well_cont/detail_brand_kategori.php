<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
	<!-- ============================================== INFO BOXES : END ============================================== -->
	<!-- ============================================== SCROLL TABS ============================================== -->
	<?php $sp=mysql_fetch_array(mysql_query("SELECT * FROM brand where id_brand ='$_GET[id_brand]'")); ?>
		...
		<div class="tab-content outer-top-xs">
			...
			<div class="tab-pane in active" id="all">			
				<div class="product-slider">
					...
					<?php
						$produk = mysql_query("SELECT * FROM produk where tampil_depan = 'Y' AND id_brand = '$_GET[id_brand]' AND id_subkategori='$_GET[id_kategori]' ORDER BY id_produk DESC limit 16");
			...
			<div class="tab-pane" id="new">
				<div class="product-slider">
					<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
						<?php
							$new = mysql_query("SELECT * FROM produk where special = 'new' AND tampil_depan = 'Y' AND id_brand = '$_GET[id_brand]' AND id_subkategori='$_GET[id_kategori]' ORDER BY id_produk DESC limit 8");
			...
			<div class="tab-pane" id="hot">
				<div class="product-slider">
					<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
						<?php
							$hot = mysql_query("SELECT * FROM produk where special = 'hot' AND tampil_depan = 'Y' AND id_brand = '$_GET[id_brand]' AND id_subkategori='$_GET[id_kategori]' ORDER BY id_produk DESC limit 8");
			...
			<div class="tab-pane" id="sale">
				<div class="product-slider">
					<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
						<?php
							$promo = mysql_query("SELECT * FROM produk where special = 'promo' AND tampil_depan = 'Y' AND id_brand = '$_GET[id_brand]' AND id_subkategori='$_GET[id_kategori]' ORDER BY id_produk DESC limit 8");
